...
absolutePathExcelOutput = relativePath + "/BenchmarkCNN_conv1d_RG30.xlsx"
...
for i in range(numberOfFilesTrain):
    ...
    currentRunSimulationInput.indexActivitySequence = activitySequences[indexFilesTrain[i]]
...
for i in range(numberOfFilesTest):
    currentRunSimulationInput = RunSimulationInput()
    currentRunSimulationInput.indexActivitySequence = activitySequences[indexFilesTest[i]]
    currentRunSimulationInput.numberOfSimulationRuns = numberOfSimulationRunsToGenerateData
    currentRunSimulationInput.timeDistribution = timeDistribution
...
for i in range(numberOfFilesTest):
    ...
    currentRunSimulation_input.indexActivitySequence = activitySequences[indexFilesTest[i]]
