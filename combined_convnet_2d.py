...
def createCombined2dConvNetNeuralNetworkModelForFutureResourceUtilisation(input_size_states, output_size_actions,
    ...
    convnetCurrentState = conv_2d(convnetCurrentState, nb_filter=16, filter_size=5, strides=1, padding='valid',
                                  activation='relu')
    convnetCurrentState = max_pool_2d(convnetCurrentState, kernel_size=2, strides=2, padding='valid')

    convnetCurrentState = conv_2d(convnetCurrentState, nb_filter=32, filter_size=3, strides=1, padding='valid',
                                  activation='relu')
    convnetCurrentState = max_pool_2d(convnetCurrentState, kernel_size=2, strides=2, padding='valid')

    convnetCurrentState = conv_2d(convnetCurrentState, nb_filter=64, filter_size=3, strides=1, padding='valid',
                                  activation='relu')
    convnetCurrentState = max_pool_2d(convnetCurrentState, kernel_size=2, strides=2, padding='valid')
    ...
    finalNet = fully_connected(finalNet, n_units=1024, weights_init='truncated_normal', activation='relu')
    finalNet = dropout(finalNet, 0.5)

    finalNet = fully_connected(finalNet, n_units=512, weights_init='truncated_normal', activation='relu')
    finalNet = dropout(finalNet, 0.5)
...
def createCombined2dConvNetNeuralNetworkModelForFutureResourceUtilisation(input_size_states, output_size_actions,
    ...
    convnetResourceUtilisation = conv_2d(convnetResourceUtilisation, nb_filter=16, filter_size=[1, 3], strides=1,
                                         padding='same', activation='relu')
...
def createCombined2dConvNetNeuralNetworkModelForFutureResourceUtilisation(input_size_states, output_size_actions,
    ...
    convnetResourceUtilisation = conv_2d(convnetResourceUtilisation, nb_filter=16, filter_size=[4, 1], strides=1,
                                         padding='same', activation='relu')
    convnetResourceUtilisation = max_pool_2d(convnetResourceUtilisation, kernel_size=[1, 10], strides=1,
                                             padding='valid')
